...
![](images/waterslide.webp){height=300px}&emsp;&emsp;![](images/bugatti-chiron-pur-sport-103-1582gg-1626097378.jpeg){height=300px}&emsp;&emsp;![](images/Alisher-Usmanov-Airbus-A340-730x524.jpg){height=300px}

2)  People living in poverty have more pressing concerns than making enviro-friendly choices.

![](images/poverty.png){height=300px}&emsp;&emsp;![](images/Blog6-FactsAboutPovertyphoto.jpg){height=300px}

## 1000 rivers with highest plastic output:

![source: https://theoceancleanup.com/sources/](images/garbage.png){height=80%}

## Missmanaged Plastic Waste Per Capita

![](images/mismanaged-plastic-waste-per-capita.png){height=900px}
...
![source: Levinson and O’Brien (2019)](images/eec.png){height=300px}
...
![source: https://i.ytimg.com/vi/m3ce5heo3ns/maxresdefault.jpg](images/ugly.jpeg){width=4,height=4}
...
![source:https://www.econlib.org/reflections-on-the-sopranos/](images/sopranos.jpg){height=300px}
...
![source:NRDC.org](images/smoking-gun.jpeg){}
